report 50027 "VATDebitNote"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\VATDebitNote.rdl';
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Notary VAT Invoice';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(LetterBodyLbl; LetterBodyLbl) { }

            column(LetterBodyLbl2; LetterBodyLbl2) { }

            column(LetterBodyLbl3; LetterBodyLbl3) { }

            column(LetterBodyLbl4; LetterBodyLbl4) { }

            column(LetterBodyLbl5; LetterBodyLbl5) { }
            ...
            column(CompCountry; CompanyCountry) { }

            column(CompFax; CompanyInfo."Fax No.") { }

            column(CompBRN; CompanyInfo."Business Registration No.") { }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column("email"; ARPayTerms."E-Mail") { }
                    column("VATREGNO"; ARPayTerms."VAT Registration No.") { }
                    column(PurchaseOrderNo; "Sales Invoice Header"."External Document No.")
                    {
                    }
                    column(NotBeneficiaryName; CompanyInfo."Beneficiary Name") { }
                    column(NotBeneficiaryAddress; CompanyInfo."Beneficiary Address") { }
                    column(NotBankName; CompanyInfo."Not Bank Name") { }
                    column(NotBankAddress; CompanyInfo."Bank Address") { }
                    column(NotAccountNo; CompanyInfo."Account No") { }
                    column(NotIban; CompanyInfo."Not IBAN") { }
                    column(NotSWIFTCode; CompanyInfo."Not SWIFT Code") { }
                    column(Header_Lbl; Header_Lbl) { }
                    //>>RCTS1.0 22Oct2019
                    ...
                    column(BankAddress; bankacc.Address + ', ' + BankAcc.City + ', ' + Country.Name) { }
                    ...
                    column(CompanyBRN; CompanyInfo."Business Registration No.") { }
                    column(CompanyPhone; CompanyInfo."Phone No.") { }
                    column(CompanyHomepage; CompanyInfo."Home Page") { }
                    column(coverLetterAdminName; CompanyInfo.CoverLetterAdminName) { }
                    column(coverLetterAdminTitle; CompanyInfo.CoverLetterAdminTitle) { }
            ...
            begin
                ...
                */
                ...
                if "Sell-to Customer Name" = "Ship-to Name" then begin
                    ShipToAddr[1] := '';
                    ShipToAddr[2] := '';
                    ShipToAddr[3] := '';
                end;
                ...
                PayText := 'Please pay our ' + "Currency Code" + ' account no. ' + BankAcc."Bank Account No." + ' without deduction of charges.';
                //<<RCTS1.0 22Oct2019
            end;
        }
    }
    ...
    var
        ...
        LetterBodyLbl: Label 'We are pleased to inform you that the project has advanced to the phase mentioned in the subject of this letter. (see certificate of the quantity surveyor in appendix).';
        LetterBodyLbl2: Label 'In accordance with the terms of the deed of sale, you will find attached the milestone invoice for the works completed.';
        LetterBodyLbl3: Label 'We wish to remind you that pursuant to “Chapitre 1 Stipulation relatives aux fractions du prix payables à terme” of the  “vente en l’état futur d’achèvement”, the funds called are payable within 8 days of our notification, otherwise default interest will accrue as of right on the outstanding amount at the rate of 1% per month.';
        LetterBodyLbl4: Label 'For any bank transfer you will effect, kindly quote reference as "Your Block No / Unit No / Invoice No / LPH / MRL"';
        LetterBodyLbl5: Label 'We look forward to receive your payment as per the deed of sale agreement.';
        brn: Text[50];
