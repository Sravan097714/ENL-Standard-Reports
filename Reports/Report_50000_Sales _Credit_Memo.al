report 50000 "Sales Credit Memo"
{
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(Contact; "Sales Cr.Memo Header"."Bill-to Contact") { }
                    column(City; "Sales Cr.Memo Header"."Bill-to City") { }
                    ...
                    column(PreAssignedNo_SalesCrMemoHeader; "Sales Cr.Memo Header"."Return Order No.")
                    {
                    }
                    ...
                    column(BankAddress; CompanyInfo."Bank Address") { }

                    column(BankAccountNo; CompanyInfo."Account No") { }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(AmtIncl; "Amount Including VAT")
                        {
                        }
                        ...
                        begin
                            ...
                            IF ("Sales Cr.Memo Line".Quantity > 0) and (PrevLineNo <> "Sales Cr.Memo Line"."Line No.") THEN BEGIN
                                LineAmt := "Line Amount";
                                AmtIncl := "Amount Including VAT";
                                PrevLineNo := "Sales Cr.Memo Line"."Line No.";
                            END else begin
                                Clear(AmtIncl);
                                Clear(LineAmt);
                            end;
            ...
            begin
                ...
                // //B2B
                // Clear(OnPost);
                // if (NoOfCopies = 0) and ("Sales Cr.Memo Header"."No. Printed" = 0) then begin
                //     NoOfCopies := "Sales Cr.Memo Header"."No. Of Copies";
                //     OnPost := true;
                // end;
                // //B2B                
                ...
                IF "Currency Code" <> '' THEN begin
                    ...
                    VatLCY += (1 / "Sales Cr.Memo Header"."Currency Factor") * ("Amount Including VAT" - Amount);
                ...
                */
                ...
                if "Sales Cr.Memo Header"."Bill-to Contact" <> '' then begin

                    CustAddr[4] := "Sales Cr.Memo Header"."Bill-to City";
                end else
                    CustAddr[3] := "Sales Cr.Memo Header"."Bill-to City";
                if "Sales Cr.Memo Header"."Ship-to Contact" <> '' then begin

                    ShipToAddr[4] := "Sales Cr.Memo Header"."Ship-to City";
                end else
                    ShipToAddr[3] := "Sales Cr.Memo Header"."Ship-to City";
    ...
    var
        ...
        PaymentTermsLbl: Label 'Total due on or before 30 days from the invoice date. Overdue accounts are subject to a service charge of 1% per Month. Cheques should be made payable to ENL Property Limited, or';
