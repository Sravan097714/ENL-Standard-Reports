report 50041 "Cover Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\CoverSalesInvoice.rdl';
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Cover Sales Invoice';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    //column(coverLetterImage; CompanyInfo.CoverLetterPicture) { }
    ...
    var
        ...
        LetterBodyLbl2: Label 'In accordance with the terms of the deed of sale, you will find attached the last milestone invoice.';
        LetterBodyLbl3: Label 'We wish to remind you that pursuant to “Chapitre 1 Stipulation relatives aux fractions du prix payables à terme” of the  “vente en l’état futur d’achèvement”, the funds called are payable within 8 days of our notification. Please note that on [date] default interest has started to accrue as of right on the outstanding amount at the rate of 1% per month.';
