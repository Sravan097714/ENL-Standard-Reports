report 50017 "Vat Entry Without BRN"
{
    ProcessingOnly = true;
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("VAT Entry"; "VAT Entry")
        {
            ...
            begin
                ...
                if ("VAT Entry"."VAT Registration No." = '') and (Customer."Business Registraton No." = '') then begin
                    ExcelBuffer1.NewRow;
                    ...
                    ExcelBuffer1.AddColumn(Customer."Business Registraton No.", FALSE, '', false, FALSE, TRUE, '', ExcelBuffer1."Cell Type"::Text);
                end;
            end;
        }
    }
