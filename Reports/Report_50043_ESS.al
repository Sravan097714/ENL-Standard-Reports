report 50043 "ENL-Standard Statement GD"
{
    RDLCLayout = 'Reports\Layout\StandardStatement.rdlc';
    WordLayout = 'Reports\Layout\StandardStatement1.docx';
    Caption = 'ENL-Standard Statement GD';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(DocNo_DtldCustLedgEntriesCaption; DocumentNo)
                {
                }
                ...
                column(RemainAmtCustLedgEntry2Caption; remamount)
                {
                }
                column(CustBalanceCaption; CustBalanceCaptionLbl)
                {
                }
                column(OriginalAmt_CustLedgEntry2Caption; origamount)
                {
                }
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        column(DocNo_DtldCustLedgEntriesCaption2; DocumentNo)
                        {
                        }
    ...
    var
        ...
        origamount: Label 'Original Amount';
        remamount: Label 'Remaining Amount';
        GLSetup: Record 98;
