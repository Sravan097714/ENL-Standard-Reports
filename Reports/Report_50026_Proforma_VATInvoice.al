report 50026 "Proforma Vat Invoice"
{
    RDLCLayout = 'Reports\Layout\ProformaVATInvoice.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(CompanyBankAddress; CompanyInfo."Company Bank Address")
            {
            }
            ...
            column(PurchaseOrderNo; "External Document No.")
            {
            }
            ...
            column(CusBRN; cust."Business Registraton No.") { }
            column(CusCity; cust.City) { }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(VATAmount_VatAmountLine; VATAmtLine)
                {
                ...
                column(Description_Line; "Description 2")
                {
                }
                ...
                begin
                    ...
                    ExtraWeightLines1.SetFilter("Line No.", '>%1', Line."Line No.");
                    ExtraWeightLines1.SetRange("Extra Weight", false);
                    if ExtraWeightLines1.FindFirst() then
                        ExtraWeightLines.SetRange("Line No.", Line."Line No." + 1, ExtraWeightLines1."Line No.")
                    else begin
                        ExtraWeightLines1.Reset();
                        ExtraWeightLines1.SetRange("Document No.", "Document No.");
                        ExtraWeightLines1.SetFilter("Line No.", '>%1', Line."Line No.");
                        if ExtraWeightLines1.FindFirst() then
                            ExtraWeightLines.SetRange("Line No.", Line."Line No." + 1, (ExtraWeightLines1."Line No." + 10000) - 1)
                    end;
                    ExtraWeightLines.SetRange("Extra Weight", true);
                    VATAmtLine := (ExtraWeightLines."Amount Including VAT" - ExtraWeightLines.Amount)
                                                       + (Line."Amount Including VAT" - Line.Amount);
                    ;
