table 50003 "Documents"
{
    ...
    fieldgroups
    {
        ...
        fieldgroup(DropDown; ID, "No.", "File Name", "File Extension", "File Type")
        {
    ...
    local procedure OnBeforeExportAttachment(var DocumentAttachment: Record "Documents")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertAttachment(var DocumentAttachment: Record "Documents"; var RecRef: RecordRef)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSaveAttachment(var DocumentAttachment: Record "Documents"; var RecRef: RecordRef; FileName: Text; var TempBlob: Codeunit "Temp Blob")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSaveAttachmentFromStream(var DocumentAttachment: Record "Documents"; var RecRef: RecordRef; FileName: Text; var DocStream: InStream)
    begin
    end;
